    ...
    return (
        <section className="py-32 bg-white relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 md:px-8 relative z-10">
                <div className="text-center max-w-3xl mx-auto mb-20 animate-fade-slide-in">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {[
                        ...
                        <div
                            key={index}
                            className="group relative bg-[#F8FAFC] rounded-[2rem] p-10 flex flex-col items-center text-center transition-all duration-500 hover:bg-emerald-50 hover:-translate-y-2 hover:shadow-xl hover:shadow-emerald-500/10 border border-transparent hover:border-emerald-100"
                        >
