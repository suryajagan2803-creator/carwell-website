    ...
    return (
        <section className="relative h-[600px] w-full flex items-center overflow-hidden bg-slate-900 border-b-4 border-emerald-600">
            ...
            <div className="container mx-auto px-6 md:px-8 relative z-20">
                <div className="max-w-xl bg-white/95 backdrop-blur-md p-8 shadow-2xl border-l-8 border-emerald-600 animate-fade-slide-in">
                    ...
                    <div className="inline-flex items-center gap-2 mb-4">
                        ...
                        <span className="text-[10px] font-bold tracking-[0.2em] text-emerald-800 uppercase">
                            Series 2026 Ready
                        </span>
                    </div>

                    {/* Headline */}
                    <h1 className="text-3xl md:text-5xl font-black text-slate-900 leading-none tracking-tight uppercase mb-4">
                        Engineered <br />
                    ...
                    <div className="flex flex-col sm:flex-row gap-3">
                        <Link
                            href="/products"
                            className="inline-flex items-center justify-center gap-2 bg-slate-900 text-white px-6 py-3 font-bold text-xs uppercase tracking-widest hover:bg-emerald-600 transition-all shadow-lg hover:shadow-emerald-500/30 rounded-none group"
                        >
                            View Machinery
                            <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                        </Link>

                        <button className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-transparent text-slate-900 border-2 border-slate-200 font-bold text-xs uppercase tracking-widest hover:border-slate-900 hover:bg-slate-50 transition-all rounded-none">
